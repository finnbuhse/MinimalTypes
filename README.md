...
These include:
  ...
  - SortedList<typename T>: A dynamic linked list which automatically sorts elements and you append them to it. It also has a size of 24 bytes. It is not a POD type.
